...
<body>
    ...
    <script>
        ...
        //     const form = document.getElementById("add_document_form");
        //     if (!form) return;
        ...
        // const fileNameText = document.getElementById("uploadFileNameAdd");
        ...
        // fileNameText.textContent = file ? `Uploading: ${file.name}` : "";
        ...
        //         progressBar.style.width = `${Math.round(simulatedProgress)}%`;
        //         percentText.textContent = `${Math.round(simulatedProgress)}%`;
        //     }
        // }, 120);

        // function stopFakeProgress(final = 100) {
        //     clearInterval(simulateInterval);
        //     progressBar.style.width = `${final}%`;
        //     percentText.textContent = `${final}%`;
        // }
        ...
        //     fileNameText.textContent = `${file.name} — Upload Complete ✓`;

        //     if ($.fn.DataTable.isDataTable("#your-table")) {
        //         $("#your-table").DataTable().ajax.reload(null, false);
        //     }

        //     setTimeout(() => resetModal(form), 1200);
        // };
    ...
    <!-- <style>
        ...
        @keyframes glowPulse {
            ...
            to {
                box-shadow: 0 0 15px #28a745, 0 0 40px #28a745;
            }
        }
