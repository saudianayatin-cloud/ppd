...
<body>
    ...
    <div class="container">
        ...
        <!-- <h3>DOCUMENTS</h3> -->
        <h3 style="text-align: left; color: #0a376e;">Document List(Environmental Section Routing)</h3>
        ...
        <div class="d-flex justify-content-end mb-2">
            <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#form_modal" hidden>
    ...
    <div class="modal fade" id="form_modal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form method="POST" action="save_environmentaldocs.php" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>REMARKS</label>
                            <textarea class="form-control" name="rem2" rows="2"></textarea>
                        </div>
            ...
            <div class="modal-content">
                <form method="POST" action="update_planningdocs.php" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <select name="rel" id="rel" class="form-control readonly-select" hidden>
                            <option value="PLANNING SECTION">PLANNING SECTION</option>
                            <option value="PROGRAMMING SECTION">PROGRAMMING SECTION</option>
                            <option value="ENVIRONMENTAL SECTION">ENVIRONMENTAL SECTION</option>
                            <option value="E-BARMM UNIT">E-BARMM UNIT</option>
    ...
    <script>
        $(document).ready(function() {
            ...
            const table = $('#your-table').DataTable({
                ...
                //     this.api().column(7).search('PLANNING SECTION').draw();
                ...
                initComplete: function() {
                    ...
                    if (relColumnIndex !== null) {
                        api.column(relColumnIndex).search('ENVIRONMENTAL SECTION').draw();
            ...
            //     $('#docFrame2').attr('src', '/admin/uploads/' + encodeURIComponent(file2));
            ...
            $('#your-table').on('click', '.view2-btn', function() {
                ...
                if (file2 && file2.trim() !== '') {
                    ...
                    //    $('#docFrame2').attr('src', 'preview.php?file2=' + encodeURIComponent(file2));
                    $('#docMessage2').hide();
                } else {
            ...
            // $('#your-table').on('click', '.view-btn2', function() {
            //     const file = $(this).data('file');

            //     if (file && file.trim() !== '') {
            //         $('#docFrame2').attr('src', '/admin/uploads/' + encodeURIComponent(file)).show();
            //         $('#docMessage2').hide();
            //     } else {
            //         $('#docFrame2').hide().attr('src', '');
            //         $('#docMessage2').show();
