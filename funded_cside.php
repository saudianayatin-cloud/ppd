...
<body>
    ...
    <div class="container">
        ...
        <!-- <h3>USERS</h3> -->
        <h3 style="text-align: left; color: #0a376e;">funded</h3>
                ...
                <form id="editUserForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group" hidden>
                            <label>Code</label>
                            <input type="text" class="form-control" name="stud_no" id="stud_no" / hidden>
                        </div>
                        ...
                        <div class="form-group" hidden>
                            <label class="required">Project Length (Km/Unit)</label hidden>
                            <input class="form-control" name="scale" id="scale">
                        </div>

                        <div class="form-group">
                            <label hidden>Project Cost</label>
                            <input class="form-control" name="cost" id="cost" hidden>
                        </div>
                        ...
                        <div class="form-group" hidden>
                            <label>Attach-URL</label>
                            <textarea class="form-control" name="attachment" id="attachment" rows="2" hidden></textarea>
                        </div>

                        <div class="form-group">
                            <label hidden>Forwarded to</label>
                            <input class="form-control" name="forwarded" id="forwarded" hidden>
                        </div>
