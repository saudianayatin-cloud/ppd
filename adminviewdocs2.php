...
<body>
    ...
    <div class="container">
        ...
        <h3 style="text-align: left; color: #0a376e;">Document List</h3>
                ...
                <form method="POST" action="update_outgoingdocs.php" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h4 class="modal-title text-primary">
                            <i class="fas fa-comments"></i> <strong>View All Remarks</strong>
                        </h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="">INCOMING REMARKS</label>
                            <textarea class="form-control" name="remarks" id="remarks" rows="3" readonly></textarea>
                        </div>


                        <div class="form-group">
                            <label for="">PLANNING/PROGRAMMING/ENVIRONMENTAL/E-BARMM UNIT/SECTION REMARKS</label>
                            <textarea class="form-control" name="rem2" id="rem2" rows="3" readonly></textarea>
                        </div>

                        <div class="form-group">
                            <label for="">OUTGOING REMARKS</label>
                            <textarea class="form-control" name="rem3" id="rem3" rows="3" readonly></textarea>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button name="update" class="btn btn-success" hidden><span class="glyphicon glyphicon-saved"></span>
                            Save</button>
                    </div>
                </form>
            </div>
            ...
            $('#btn_yes').on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        console.log("Server response for ID " + id + ":", response);

                        $("#modal_confirm").modal('hide');
                        $("#row_" + id).html("<td colspan='6'><center class='text-danger'>Deleting...</center></td>");

                        if (response.success) {
                            // ✅ Wait a moment before refreshing for smoother UX
                            setTimeout(function() {
                    ...
                    error: function(xhr, status, error) {
                        console.error("AJAX error for ID " + id + ":", status, error);
