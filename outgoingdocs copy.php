...
<body>
    ...
    <div class="container">
        ...
        <!-- <h2>DOCUMENTS</h2> -->
        <h3 style="text-align: left; color: #0a376e;">Document List(Outgoing Routing)</h3>
    ...
    <div class="modal fade" id="form_modal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form id="add_document_form" enctype="multipart/form-data">
                    
                    <!-- <form id="add_document_form" method="POST" action="save_outgoingdocs.php" enctype="multipart/form-data"> -->
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>RECEIVED/ENTERED BY</label>
                            ...
                            <div class="form-group">
                                <label>REMARKS</label>
                                <textarea class="form-control" name="rem3" rows="2"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <!-- <select name="rel" class="form-control readonly-select">
                                <option value=" "> </option>
                                ...
                                <textarea class="form-control" name="rel" rows="2"></textarea>
                            </div>
   ...
   <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addForm.addEventListener('submit', function(e) {
                ...
                // ✅ Show file name above progress bar
                if (file) {
                    if (!document.getElementById('uploadFileNameAdd')) {
                        const fileNameElem = document.createElement('div');
                        fileNameElem.id = 'uploadFileNameAdd';
                        fileNameElem.className = 'mt-2 text-muted small';
                        progressContainer.parentNode.insertBefore(fileNameElem, progressContainer);
                    }
                    document.getElementById('uploadFileNameAdd').textContent = `Uploading: ${file.name}`;
                }
                ...
                xhr.upload.addEventListener('progress', function(e) {
                    if (e.lengthComputable && e.total > 0) {
                        ...
                        const speedText = isFinite(speed) ? `${speed.toFixed(1)} KB/s` : '';
                        if (file) {
                            document.getElementById('uploadFileNameAdd').textContent =
                                `Uploading: ${file.name} — ${speedText}`;
                        }
                    }
                });
                ...
                xhr.addEventListener('load', function() {
                    ...
                    setTimeout(() => {
                        ...
                        const fileNameElem = document.getElementById('uploadFileNameAdd');
                        if (fileNameElem) fileNameElem.remove();
                    }, 1200);
                });
                ...
                // ✅ Send request
                xhr.open('POST', 'save_outgoingdocs.php', true);
            ...
            <div class="modal-content">
                <form method="POST" action="update_outgoingdocs.php" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="">RECEIVED/ENTERED BY</label>
                        ...
                        <div class="form-group">
                            <label for="">REMARKS</label>
                            <textarea class="form-control" name="rem3" id="rem3" rows="3"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="rel" id="rel" rows="3"></textarea>
                        </div>
    ...
    <script>
        function openModal(rowData) {
            ...
            document.getElementById('rem3').value = rowData.rem3;
            ...
            const table = $('#your-table').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        <button style="margin-top: 1px;" class="btn btn-secondary btn-sm edit-btn" data-row="${meta.row}">
