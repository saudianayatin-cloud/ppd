...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Save record in DB
    $sql = "INSERT INTO `documents` (`stud_no`, `req`, `dat`, `subject`, `con`, `type`, `rem2`, `rel`, `file2`) 
            VALUES ('$stud_no','$req','$dat','$subject','$con','$type', '$rem2','$rel','$fileNameToSave')";

    if (mysqli_query($conn, $sql)) {
        header("Location: environmentaldocs.php"); // redirect back to your main page
        exit();
    } else {
